<footer class="footer bg-slate-200 text-base-content px-10 py-6">
  ...
  <nav>
    ...
    <a class="link link-hover flex gap-2"><img width="21" height="21" src="https://img.icons8.com/ios/21/globe--v1.png" alt="globe--v1"/>Kantor Pusat - Jalan Veteran 129 Gresik 61122, Indonesia</a>
    <a class="link link-hover flex gap-2"><img width="21" height="21" src="https://img.icons8.com/dotty/21/fax.png" alt="fax"/>Faks : (62-31) 3982304</a>
    <a class="link link-hover flex gap-2"><img width="21" height="21" src="https://img.icons8.com/ios/21/phone.png" alt="phone"/>Telepon : (62-31) 3982304</a>
    <a class="link link-hover flex gap-2"><img width="21" height="21" src="https://img.icons8.com/ios/21/mail.png" alt="mail"/>contact@silog.co.id</a>
    <a class="link link-hover flex gap-2"><img width="21" height="21" src="https://img.icons8.com/ios/21/clock.png" alt="clock"/>Senin - Jum'at : 07.30 - 16.30 WIB</a>
  </nav>
  <nav>
    <h6 class="footer-title">Social Media</h6>
    <a href="{{ url('https://www.instagram.com/silogindonesia/') }}" class="flex items-center gap-2">
    ...
    <a href="{{ url('https://www.youtube.com/@silogindonesia2868') }}" class="flex items-center gap-2">
      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48">
    ...
    <a href="{{ url('https://www.facebook.com/semenindonesialogistic/') }}" class="flex items-center gap-2">
      <img width="24" height="24" src="https://img.icons8.com/color/24/facebook-new.png" alt="facebook-new"/>
      Silog
    </a>
    <a href="{{ url('https://x.com/silogindonesia') }}" class="flex items-center gap-2">
      <img width="24" height="24" src="https://img.icons8.com/ios-filled/24/twitterx--v1.png" alt="twitterx--v1"/>
